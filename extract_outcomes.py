...
- Ordinary shift-note narrative: chores, incidents, behavioral notes, staff accommodations, medical complaints/symptoms with no confirmed outcome tied to a specific taxonomy type. EXCEPTION: hygiene/self-care activities (showering, washing clothes, personal care) noted by staff CAN be a legitimate Life Skills outcome (e.g. "Learned self-care life skill", "Learned cleaning life skill") - do not dismiss these as "ordinary narrative" just because they sound mundane; match them against the Life Skills types like anything else.
